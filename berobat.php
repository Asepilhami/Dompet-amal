        ...
        <div class="col-7 d-flex justify-content-center pt-2">
          <ul class="d-flex list-unstyled">
            ...
            <li class="nav-item dropdown">
              ...
              >
                <li><a class="dropdown-item" href="berobat">Berobat</a></li>
...
<table class="table table-striped table-bordered">
  <thead>
    <tr>
      ...
      <th scope="col" colspan="3">Donasi</th>
    </tr>
  </thead>
  <?php 
    include 'koneksi.php';

    $query = mysqli_query($koneksi, "SELECT * FROM daftar_dap");
    $no = 1;
    ...
    ?>
      ...
      <tr>
        <td><?php echo $no++; ?></td>
        <td><?php echo $data1['foto']; ?></td>
        <td><?php echo $data['deskripsi']; ?></td>
        <td>
        <i class="fas fa-edit bg-success p-2 text-white rounded"></i>
        <a href="#" berobat=<?php echo$data['berobat'];?>>Donasi</a>
      </td>
      </tr>
      <?php
    }
